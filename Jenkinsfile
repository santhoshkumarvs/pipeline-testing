pipeline {
    ...
    stages {
        ...
        stage('Deploy to Docker Host') {
          steps {
            sh    'docker -H tcp://10.0.0.101:2375 stop testingwebapp1 || true'
            sh    'docker -H tcp://10.0.0.101:2375 run --rm -dit --name testingwebapp1 --hostname testingwebapp1 -p 8001:80 sreeharshav/pipelinetestprod:${BUILD_NUMBER}'
            }
        }
