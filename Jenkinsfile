pipeline {
    ...
    stages {
        ...
        stage('Deploy to Docker Host') {
          steps {
            sh    'docker -H tcp://10.0.0.101:2375 stop DEVwebapp1 || true'
            sh    'docker -H tcp://10.0.0.101:2375 run --rm -dit --name DEVwebapp1 --hostname DEVwebapp1 -p 8003:80 sreeharshav/pipelinetestprod:${BUILD_NUMBER}'
            }
        }
